...
export default function HeroSection() {
  ...
  return (
    <section className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-24 bg-gradient-to-b from-white via-gray-50 to-blue-50 relative">
      <div className="max-w-[800px] w-full mx-auto my-8">
        <div className="max-w-[800px] w-full mx-auto text-center mb-8">
          <h1 className="font-extrabold bg-gradient-to-r from-red-500 via-pink-500 to-blue-500 bg-clip-text text-transparent drop-shadow-lg text-[clamp(2rem,7vw,3.5rem)]">
            YouTube Monetization Checker
          </h1>
        </div>
        <div className="max-w-[800px] w-full mx-auto">
          <div className="bg-white/95 rounded-2xl shadow-2xl px-8 py-14 md:p-16 flex flex-col items-center">
            ...
            <form onSubmit={handleSubmit} className="max-w-2xl mx-auto mb-12 w-full">
              <div className={
            ...
            <div className="w-full max-w-xl mx-auto border-t border-gray-100 mb-2" />
            ...
            {result && result.success && result.data && (
              <div className="bg-white/95 p-6 rounded-2xl shadow-2xl max-w-md mx-auto flex flex-col items-center mt-14 border border-gray-100">
      ...
      <div className="absolute left-0 right-0 bottom-0 h-24 bg-gradient-to-b from-transparent to-blue-100 pointer-events-none" />
    </section>
  );
} 